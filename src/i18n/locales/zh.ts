export default {
  ...
  landing: {
    ...
    faq: {
      ...
      q2: {
        question: "数字范围有什么限制？",
        answer: "默认数字范围是 1-16。房间创建者可以自定义范围，但最大数字和最小数字之间的差值必须小于 256，以确保 FHE 的最佳性能。"
      },
      q3: {
        question: "参与游戏需要多少费用？",
      ...
      q5: {
        question: "如何保证隐私？能看到别人的数字吗？",
        answer: "不可能在揭晓前看到别人的数字！您选择的数字使用 ZAMA 的全同态加密（FHE）技术进行加密。所有数字对所有玩家甚至智能合约都完全隐藏，直到游戏结束时同时揭晓，确保完全公平和隐私保护。"
      },
      q6: {
        question: "游戏什么时候结束？",
